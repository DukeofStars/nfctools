...
fn ColorField(props: ColorFieldProps) -> Element {
    ...
    rsx! {
        div { class: "dx-color-field-container", ..props.attributes,
            if let Some(label) = props.label {
                Label { html_for: "color_field", class: "dx-color-slider-title", {label} }
            }
            input {
                id: "color_field",
...
fn ColorSlider(props: ColorSliderProps) -> Element {
    ...
    rsx! {
        ...
        div { class: "dx-color-slider-container", ..props.attributes,
            ...
            Slider {
                ...
                SliderTrack { class: "dx-color-slider-track",
                    SliderThumb {
...
fn ColorArea(props: ColorAreaProps) -> Element {
    rsx! {
        color_picker::ColorArea {
            ...
            step: props.step,
            attributes: props.attributes,
            color_picker::AreaTrack { color_picker::AreaThumb {} }
            {props.children}
        }
    }
}
...
pub fn ColorPickerSelect(props: ColorPickerSelectProps) -> Element {
    ...
    rsx! {
        div { class: "dx-color-picker-dialog", ..props.attributes,
            ColorArea {}
            ColorSlider { title: "Hue" }
            div { class: "dx-color-picker-input",
